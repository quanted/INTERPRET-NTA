  ...
  var columnDefs = [
    ...
    {headerName: "Hazard", 
      children: [
        ...
        {columnGroupShow: "closed", headerName: "Hazard Completeness Score", field: 'Hazard Completeness Score', floatingFilter: true, filter: 'agNumberColumnFilter', width: 210, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Hazard Completeness Score"] ?? 'N/A'}},
        ...
        {columnGroupShow: "open", headerName: "Hazard Completeness Score", field: 'Hazard Completeness Score', floatingFilter: true, filter: 'agNumberColumnFilter', width: 200, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Hazard Completeness Score"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Acute Aquatic Toxicity Authority", field: 'Acute Aquatic Toxicity_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Acute Aquatic Toxicity_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Acute Aquatic Toxicity Score", field: 'Acute Aquatic Toxicity_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Acute Aquatic Toxicity_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Acute Mammalian Toxicity Dermal Authority", field: 'Acute Mammalian Toxicity Dermal_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Acute Mammalian Toxicity Dermal_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Acute Mammalian Toxicity Dermal Score", field: 'Acute Mammalian Toxicity Dermal_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Acute Mammalian Toxicity Dermal_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Acute Mammalian Toxicity Inhalation Authority", field: 'Acute Mammalian Toxicity Inhalation_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Acute Mammalian Toxicity Inhalation_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Acute Mammalian Toxicity Inhalation Score", field: 'Acute Mammalian Toxicity Inhalation_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Acute Mammalian Toxicity Inhalation_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Acute Mammalian Toxicity Oral Authority", field: 'Acute Mammalian Toxicity Oral_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Acute Mammalian Toxicity Oral_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Acute Mammalian Toxicity Oral Score", field: 'Acute Mammalian Toxicity Oral_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Acute Mammalian Toxicity Oral_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Bioaccumulation Authority", field: 'Bioaccumulation_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Bioaccumulation_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Bioaccumulation Score", field: 'Bioaccumulation_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Bioaccumulation_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Carcinogenicity Authority", field: 'Carcinogenicity_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Carcinogenicity_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Carcinogenicity Score", field: 'Carcinogenicity_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Carcinogenicity_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Chronic Aquatic Toxicity Authority", field: 'Chronic Aquatic Toxicity_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Chronic Aquatic Toxicity_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Chronic Aquatic Toxicity Score", field: 'Chronic Aquatic Toxicity_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Chronic Aquatic Toxicity_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Developmental Authority", field: 'Developmental_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Developmental_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Developmental Score", field: 'Developmental_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Developmental_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Endocrine Disruption Authority", field: 'Endocrine Disruption_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Endocrine Disruption_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Endocrine Disruption Score", field: 'Endocrine Disruption_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Endocrine Disruption_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Exposure Authority", field: 'Exposure_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Exposure_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Exposure Score", field: 'Exposure_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Exposure_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Eye Irritation Authority", field: 'Eye Irritation_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Eye Irritation_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Eye Irritation Score", field: 'Eye Irritation_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Eye Irritation_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Genotoxicity Mutagenicity Authority", field: 'Genotoxicity Mutagenicity_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Genotoxicity Mutagenicity_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Genotoxicity Mutagenicity Score", field: 'Genotoxicity Mutagenicity_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Genotoxicity Mutagenicity_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Neurotoxicity Repeat Exposure Authority", field: 'Neurotoxicity Repeat Exposure_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Neurotoxicity Repeat Exposure_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Neurotoxicity Repeat Exposure Score", field: 'Neurotoxicity Repeat Exposure_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Neurotoxicity Repeat Exposure_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Neurotoxicity Single Exposure Authority", field: 'Neurotoxicity Single Exposure_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Neurotoxicity Single Exposure_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Neurotoxicity Single Exposure Score", field: 'Neurotoxicity Single Exposure_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Neurotoxicity Single Exposure_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Persistence Authority", field: 'Persistence_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Persistence_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Persistence Score", field: 'Persistence_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Persistence_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Reproductive Authority", field: 'Reproductive_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Reproductive_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Reproductive Score", field: 'Reproductive_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Reproductive_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Skin Irritation Authority", field: 'Skin Irritation_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Skin Irritation_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Skin Irritation Toxicity Score", field: 'Skin Irritation_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Skin Irritation_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Skin Sensitization Authority", field: 'Skin Sensitization_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Skin Sensitization_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Skin Sensitization Score", field: 'Skin Sensitization_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Skin Sensitization_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Systemic Toxicity Repeat Exposure Authority", field: 'Systemic Toxicity Repeat Exposure_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Systemic Toxicity Repeat Exposure_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Systemic Toxicity Repeat Exposure Score", field: 'Systemic Toxicity Repeat Exposure_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Systemic Toxicity Repeat Exposure_score_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Systemic Toxicity Single Exposure Authority", field: 'Systemic Toxicity Single Exposure_authority_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Systemic Toxicity Single Exposure_authority_mapped"] ?? 'N/A'}},
        {columnGroupShow: "open", headerName: "Systemic Toxicity Single Exposurey Score", field: 'Systemic Toxicity Single Exposure_score_mapped', floatingFilter: true, filter: 'agNumberColumnFilter', width: 100, sortingOrder: ['desc', 'asc', null], valueGetter: (params) => {return params.data?.["Systemic Toxicity Single Exposure_score_mapped"] ?? 'N/A'}},
      ]
    }
  ];
